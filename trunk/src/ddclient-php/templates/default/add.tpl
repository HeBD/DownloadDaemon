<form action="index.php?site=add" method="post">
	<fieldset>
		...
		<label for="submit"> </label><input type="submit" value="{L_Add_single_DL}" name="submit_single" id="submit" >
	</fieldset>

	<fieldset>
		<legend>{L_Add_multi_DL}:</legend>
		<label for="urls">{L_URL}s:</label><textarea name="titles_urls" cols="120" rows="20" id="urls"></textarea><br >
		<label for="submit"> </label><input type="submit" value="{L_Add_multi_DL}" name="submit_multiple" id="submit" >
		{L_Add_multi_DL_Desc}
	</fieldset>
</form>
