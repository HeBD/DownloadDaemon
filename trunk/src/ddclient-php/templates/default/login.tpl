<form action="index.php?site=login" method="post">
	<fieldset>
		...
		<label for="host">{L_Host}/{L_Port}:</label><input type="text" name="host" value="{C_DEFAULT_HOST}" id="host" > <input type="text" name="port" value="{C_DEFAULT_PORT}" size="5" id="port"><br >
